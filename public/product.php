...
<main>
    ...
    <div class="container">
      <div class="header">
        ...
        <?php $query = mysqli_query($db, "SELECT * FROM product WHERE category_id='".$category_id."'") or die(mysqli_error($db)); ?>
            ...
            <section>
              ...
              <article>
                <div class="display">
                  <image>
                    <img src="../images/<?php echo$rec[6] ?>" width="150px" height="150px"><br>
                    <a href="details.php?id=<?php echo$rec[0]?>" class="btn btn-outline-light btn-sm px-2">Details</a>
                  </image> 
                </div> 
              </article>
            </section>
